...
sp_oauth = oauth2.SpotifyOAuth(SPOTIPY_CLIENT_ID, SPOTIPY_CLIENT_SECRET, SPOTIPY_REDIRECT_URI, show_dialog=True)
...
def home():
    ...
    return render_template('home.html', imgs=imgs, list=get_top_songs(sp))
